...
! function (a) {
    ...
    ! function (a) {
                ...
                var c = {},
                    ...
                    j = function (b, i) {
                        ...
                        d(i) ? c[k.attr("id")] = h[b]({
                            ...
                            e(j, a(this).attr("id")) === -1 && j.push(a(this).attr("id"))
                        }), g(j, function (a) {
                            c[a] = h[b]({
                                $: f.find('input[name="' + a + '"]')
                            })
        ...
        a.fn.inputVal = function (b) {
            ...
            return c.is("input, textarea, select") ? "undefined" == typeof b ? d[c.attr("id")].get() : (d[c.attr("id")].set(b), c) : "undefined" == typeof b ? p(d, "get") : (g(b, function (a, b) {
                d[b].set(a)
            }), c)
                ...
                v = function (b, c, d) {
                    b.each(function (b) {
                        ...
                        e.data("item-name", c + "[" + b + "]"), l(e.find("[name]"), d).each(function () {
                            var f = a(this),
                                g = f.attr("id").match(/\[[^\]]+\]/g),
                                i = g ? h(g).replace(/\[|\]/g, "") : f.attr("id"),
                                j = c + "[" + b + "][" + i + "]" + (f.is(":checkbox") || f.attr("multiple") ? "[]" : "");
                            f.attr("id", j), u(d, e, function (d) {
                                var e = a(this);
