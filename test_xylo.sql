...
--
-- Struktur dari tabel `biaya_parkirs`
--

CREATE TABLE `biaya_parkirs` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `one_hour` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `next_hours` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(5, '2022_08_27_175605_create_permission_tables', 1),
(6, '2022_08_27_235922_create_biaya_parkirs_table', 1),
(7, '2022_08_28_083628_create_record_parkings_table', 1),
(8, '2022_08_28_095229_create_payment_methods_table', 1);
...
--
-- Struktur dari tabel `record_parkings`
--

CREATE TABLE `record_parkings` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `status` int(11) NOT NULL,
  `code_park` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `paymentmethod_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `path_qr` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `path_barcode` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Indeks untuk tabel `biaya_parkirs`
--
ALTER TABLE `biaya_parkirs`
  ADD PRIMARY KEY (`id`);
...
--
-- Indeks untuk tabel `record_parkings`
--
...
--
-- AUTO_INCREMENT untuk tabel `biaya_parkirs`
--
ALTER TABLE `biaya_parkirs`
